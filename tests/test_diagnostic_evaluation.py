...
def test_investigator_emits_resolvable_evidence_and_two_ranked_candidates():
    start = datetime(2025, 2, 12, tzinfo=timezone.utc)
    cycles = [
        {"timestamp": start - timedelta(minutes=2), "machine_erp_ref": "152", "barrel_temp_zone2_c": 210, "scrap_flag": False},
        {"timestamp": start - timedelta(minutes=1), "machine_erp_ref": "152", "barrel_temp_zone2_c": 211, "scrap_flag": False},
    ] + [
